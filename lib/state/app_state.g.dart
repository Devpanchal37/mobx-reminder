...
mixin _$AppState on _AppState, Store {
  ...
  late final _$_loadReminderAsyncAction =
      AsyncAction('_AppState._loadReminder', context: context);

  @override
  Future<bool> _loadReminder() {
    return _$_loadReminderAsyncAction.run(() => super._loadReminder());
  }
